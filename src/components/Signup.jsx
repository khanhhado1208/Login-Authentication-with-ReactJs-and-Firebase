...
/*
* useState is React hook used to manage state within a functional component
* auth: representing the Firebase Authentication service
* createUserWithEmailAndPassword  : related to authentication methods or providers in Firebase
* Link: create links that allow navigation between different routes in your React application
